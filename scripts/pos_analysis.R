...
### Size 50
pos_results_50 <- read.csv('../results/new_50_pos_results.txt', header = T, sep = ' ', row.names = NULL)
head(pos_results)
pos_results_50 <- subset(pos_results_50, Metric == 'f1')
pos_results_50$Total <- as.numeric(pos_results_50$Total)

### VIP language, Russian
### also plot for different treebanks (add different initial sizes later)

subset(pos_results_50, Language == 'Russian' & Total <= 100000) %>%
